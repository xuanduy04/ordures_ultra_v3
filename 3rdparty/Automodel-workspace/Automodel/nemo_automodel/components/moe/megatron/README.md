...
This module is forked from [megatron/core/transformer/moe](https://github.com/NVIDIA/Megatron-LM/blob/main/megatron/core/transformer/moe) with minor modifications to remove dependencies on megatron core.
