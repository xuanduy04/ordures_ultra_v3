...
# TODO(liding): create nemotron_3 folder, instead of nemotronh
...
HF_MODEL_ID_TO_BRIDGE_MODEL_PROVIDER = {
    # TODO(liding): use official HF model id
    "nvidia/nemotron-super-sft-012726": Nemotron3SuperProvider,
}


# TODO(liding): rename "NemotronH"
